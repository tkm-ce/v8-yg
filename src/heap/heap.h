...
#undef ROOT_ACCESSOR
  ...
  void update_young_gen_size(size_t mj, double sj_bytes, double sj_time, double gi_bytes, double gi_time);
...
public:
  ...
  std::atomic<double> g_bytes{0}, g_time{0}, s_bytes{0}, s_time{0}, gi_allocated_bytes{0}, gi_size_of_object{0}, gi_time{0}, last_gi_time{0};
